...
import creatboard15.dto.Article;
import creatboard15.util.Util;
...
//		System.out.printf("%d번 게시물은 존재 합니다\n",id);
	...
	public void makeTestDate() {
		...
		articles.add(new Article(1, Util.getNowDateStr(),1, "테스트1", "테스트1", 10));
		articles.add(new Article(2, Util.getNowDateStr(),2, "테스트2", "테스트2", 20));
		articles.add(new Article(3, Util.getNowDateStr(),2, "테스트3", "테스트3", 30));
	}
